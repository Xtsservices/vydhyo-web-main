    ...
    <div style={pageStyle}>
      ...
      <div style={leftColStyle}>
        ...
        onError={e => {
          ...
          />
          <div>
        <div style={doctorNameStyle}>
          Dr. Karthik Vallala, Cardio Thoracic Surgeon
        </div>
        <div style={doctorDegreeStyle}>MBBS, DNB (CT)</div>
        <div style={doctorSpecialtyStyle}>Cardio Thoracic Surgeon</div>
        ...
        <li>67935 Telangana State Medical Council 2010</li>
          ...
          {/* --- Inserted Section: Reviews, Q&A, Media --- */}
          {/* Patient Reviews */}
          <div style={mainCardStyle}></div>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <span style={iconStyle}>⭐</span>
            <span style={{ fontWeight: 600, fontSize: "1.1rem" }}>Dr. Karthik Vallala, Cardio Thoracic Surgeon Reviews</span>
          </div>
            <button
            style={{
            ...
            <div style={{
              ...
              >
                ...
                <div>
                <div style={{ fontWeight: 500, marginBottom: 4 }}>Do you recommend this Doctor for</div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
          <span style={{ fontWeight: 600, fontSize: "1.1rem" }}>Question & Answers by Dr. Karthik Vallala</span>
        </div>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "32px 0" }}>
          <img
            src="./images/QA.png"
        ...
        <div style={{ marginBottom: 16 }}>
          <span style={{ fontWeight: 600, fontSize: "1.1rem", color: "#1e40af" }}>Media from Dr. Karthik Vallala</span>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "32px 0" }}></div></div></div>
          ...
          {bookingStep === 2 && (
            <form onSubmit={handleBookingSubmit} style={bookingFormStyle}>
              ...
              <div style={formRowStyle}>
                ...
                <div style={{...formGroupStyle, flex: 1, marginLeft: 12}}>
